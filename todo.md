...
- [ ] Scope remaining file surfaces that still use default/demo owners to the signed-in account, including `app/trash/page.tsx`, `app/webdisk/page.tsx`, `app/bridge/api.v1/activity/route.ts`, `app/bridge/api.v1/folders/create/route.ts`, and WebDisk operation routes.
