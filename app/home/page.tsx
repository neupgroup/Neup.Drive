...
Shows the recent-items landing page at the canonical homepage route with a
personalized welcome message derived from the signed-in account when available.
